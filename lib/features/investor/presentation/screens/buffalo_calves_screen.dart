...
//       if (_rootNode.images == null || _rootNode.images!.isEmpty) {
...
//       _rootNode = InvestorAnimal(animalId: widget.parentId, images: widget.calves);
//     }
//   }
...
//     final effectiveRoot =
//         widget.parent ?? InvestorAnimal(animalId: widget.parentId, images: widget.calves);
//     // If the parent object doesn't have the children list populated but we have it in widget.calves:
//     final rootChildren =
//         (effectiveRoot.images != null && effectiveRoot.images!.isNotEmpty)
//         ? effectiveRoot.images!
//         : widget.calves;
...
//           : AppTheme.lightGrey,
//       appBar: AppBar(
//         title: Text('Lineage: ${widget.parent?.farmName ?? widget.parentId}'),
//         centerTitle: true,
