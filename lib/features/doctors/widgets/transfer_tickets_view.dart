...
class TransferTicketsView extends ConsumerStatefulWidget {
  ...
  ConsumerState<TransferTicketsView> createState() =>
      _TransferTicketsViewState();
}

class _TransferTicketsViewState extends ConsumerState<TransferTicketsView>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          Colors.transparent, // Handle background in parent if needed
      body: Column(
        children: [
          TabBar(
