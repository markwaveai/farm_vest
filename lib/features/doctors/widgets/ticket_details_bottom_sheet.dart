...
class TicketDetailsBottomSheet extends ConsumerWidget {
  final Ticket ticket;

  TicketDetailsBottomSheet({super.key, required this.ticket});
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        'Process Ticket / Mark Status'.tr(ref),
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
